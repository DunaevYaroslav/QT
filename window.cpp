...
{  
  ...
  QPen pen_darkYellow(Qt::darkYellow, 0, Qt::SolidLine);
  QPen pen_red(Qt::red, 0, Qt::SolidLine); 
  QPen pen_green(Qt::yellow, 0, Qt::SolidLine);
 ...
 if ((view_id == 0 || view_id == 2) && n <= 50){
     ...
     painter.drawText (0, 30, QString("Состав отображаемых графиков = %1").arg(view_id + 1));
     painter.drawText (0, 45, QString("Масштаб = %1 %2 %3").arg(s).arg(a).arg(b));
